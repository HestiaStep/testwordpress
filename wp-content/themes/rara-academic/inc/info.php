...
7. Save changes', 'rara-academic'),
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'rara-academic' ) . ': </label><a href="' . esc_url( 'http://raratheme.com/previews/?theme=rara-academic' ) . '" target="_blank">' . __( 'here', 'rara-academic' ) . '</a></span><br />';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View documentation', 'rara-academic' ) . ': </label><a href="' . esc_url( 'http://raratheme.com/documentation/rara-academic/' ) . '" target="_blank">' . __( 'here', 'rara-academic' ) . '</a></span><br />';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Download Zip', 'rara-academic' ) . ': </label><a href="' . esc_url( 'https://raratheme-wbtneb0y4p.netdna-ssl.com/wp-content/uploads/2017/12/rara-academic-demo-content.zip' ) . '" target="_blank">' . __( 'here', 'rara-academic' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme info', 'rara-academic' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/wordpress-themes/rara-academic/' ) . '" target="_blank">' . __( 'here', 'rara-academic' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Support ticket', 'rara-academic' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/support-ticket/' ) . '" target="_blank">' . __( 'here', 'rara-academic' ) . '</a></span><br />';
	...
	$theme_info .= '<span class="sticky_info_row"><label class="more-detail row-element">' . __( 'More WordPress Themes', 'rara-academic' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/wordpress-themes/' ) . '" target="_blank">' . __( 'here', 'rara-academic' ) . '</a></span><br />';
	...
	$manager->add_section(
		new Rara_Academic_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => 'https://raratheme.com/wordpress-themes/rara-academic-pro/'
			)
		)
	);
}