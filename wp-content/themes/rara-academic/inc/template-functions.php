		    ...
		    <div class="container">
			    <div class="site-branding" itemscope itemtype="http://schema.org/Organization">
			       <?php 
                    ...
                    <?php echo CFS()->get( 'contacts_email' ); ?>
			    </div><!-- .site-branding -->
...
*/
    ...
    ?>
		<div class="site-info">
            ...
            <?php }  ?>
            <?php echo esc_html__( 'Rara Academic by ', 'rara-academic' ); ?>
            <a href="<?php echo esc_url( 'https://raratheme.com/' ); ?>" rel="nofollow" target="_blank"><?php echo esc_html__( 'Rara Theme', 'rara-academic' ); ?></a>
